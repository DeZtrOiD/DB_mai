...
CREATE TABLE lab_3.content_items (
...
CREATE TABLE lab_3.genres (
    genre_id SMALLINT GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    name VARCHAR(100) NOT NULL UNIQUE
);

CREATE TABLE lab_3.content_genres (
    item_id BIGINT NOT NULL REFERENCES lab_3.content_items(item_id) ON DELETE CASCADE,
    genre_id SMALLINT NOT NULL REFERENCES lab_3.genres(genre_id) ON DELETE CASCADE,
    PRIMARY KEY (item_id, genre_id)
);


CREATE TABLE lab_3.authors (
...
CREATE TABLE lab_3.roles (
    role_id SMALLINT GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    role_name VARCHAR(50) NOT NULL UNIQUE
);

CREATE TABLE lab_3.content_credits (
    item_id BIGINT NOT NULL REFERENCES lab_3.content_items(item_id) ON DELETE CASCADE,
    author_id BIGINT NOT NULL REFERENCES lab_3.authors(author_id) ON DELETE RESTRICT,
    role_id SMALLINT NOT NULL REFERENCES lab_3.roles(role_id) ON DELETE RESTRICT,
    PRIMARY KEY (item_id, author_id, role_id)
);


CREATE TABLE lab_3.book_metadata (
    isbn VARCHAR(20) PRIMARY KEY,
    pages INTEGER,
    publication_date DATE
);

CREATE TABLE lab_3.book_details (
    item_id BIGINT PRIMARY KEY REFERENCES lab_3.content_items(item_id) ON DELETE CASCADE,
    isbn VARCHAR(20) NOT NULL UNIQUE REFERENCES lab_3.book_metadata(isbn) ON DELETE RESTRICT
);


CREATE TABLE lab_3.film_details (
    item_id BIGINT PRIMARY KEY REFERENCES lab_3.content_items(item_id) ON DELETE CASCADE,
...
CREATE TABLE lab_3.music_details (
    item_id BIGINT PRIMARY KEY REFERENCES lab_3.content_items(item_id) ON DELETE CASCADE,
...
CREATE TABLE lab_3.user_collections (
    user_id BIGINT NOT NULL REFERENCES lab_3.users(user_id) ON DELETE CASCADE,
    item_id BIGINT NOT NULL REFERENCES lab_3.content_items(item_id) ON DELETE CASCADE,
    PRIMARY KEY (user_id, item_id)
);


CREATE TABLE lab_3.playlists (
...
CREATE TABLE lab_3.playlist_items (
    playlist_id BIGINT NOT NULL REFERENCES lab_3.playlists(playlist_id) ON DELETE CASCADE,
    item_id BIGINT NOT NULL REFERENCES lab_3.content_items(item_id) ON DELETE CASCADE,
    PRIMARY KEY (playlist_id, item_id)
);

CREATE TABLE lab_3.ratings (
    user_id BIGINT NOT NULL REFERENCES lab_3.users(user_id) ON DELETE CASCADE,
    item_id BIGINT NOT NULL REFERENCES lab_3.content_items(item_id) ON DELETE CASCADE,
...
ALTER TABLE lab_3.content_items
...
ALTER TABLE lab_3.film_details
...
ALTER TABLE lab_3.music_details
