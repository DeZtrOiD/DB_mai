...
| +1 B-tree | +33.6% | -94.2%* |
| +1 GIN | +64.3% | -61.5%* |
| Все 6 индексов | +410.5% | -84.0%* |

*Отрицательный оверхеад для UPDATE объясняется кэшированием: после создания индексов данные и метаданные уже находятся в `shared_buffers`, что ускоряет последующие операции.
