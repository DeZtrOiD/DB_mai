...
TRUNCATE TABLE
  lab_2.ratings,
  lab_2.playlist_items,
  lab_2.playlists,
  lab_2.user_collections,
  lab_2.music_details,
  lab_2.film_details,
  lab_2.book_details,
  lab_2.book_metadata,
  lab_2.content_credits,
  lab_2.content_genres,
  lab_2.content_items,
  lab_2.authors,
  lab_2.roles,
  lab_2.genres,
...
INSERT INTO lab_2.authors(name, birth_date)
SELECT
  'Author ' || gs,
  DATE '1940-01-01' + (gs % 25000)
FROM generate_series(1, 100) gs;

INSERT INTO lab_2.content_items(title, description, language_code)
SELECT
  'Content ' || gs,
  'Description ' || gs,
...
INSERT INTO lab_2.book_metadata(isbn, pages, publication_date)
SELECT
  '978-' || gs,
  100 + (gs % 500),
...
INSERT INTO lab_2.book_details(item_id, isbn)
SELECT
  gs,
  '978-' || gs
FROM generate_series(1, 500) gs;

INSERT INTO lab_2.film_details(item_id, duration_minutes, age_rating, publication_date)
SELECT
  gs,
  80 + (gs % 100),
...
INSERT INTO lab_2.music_details(item_id, duration_seconds, album, track_number, publication_date)
SELECT
  gs,
  120 + (gs % 300),
  'Album ' || ((gs-1000)/10),
...
INSERT INTO lab_2.content_genres(item_id, genre_id)
SELECT
  i,
  ((i + g) % 10) + 1
...
INSERT INTO lab_2.content_credits(item_id, author_id, role_id)
SELECT
  i,
  ((i + c) % 100) + 1,
  ((i + c) % 7) + 1
...
INSERT INTO lab_2.user_collections(user_id, item_id)
SELECT
  u,
  ((u*37 + i) % 1500) + 1
